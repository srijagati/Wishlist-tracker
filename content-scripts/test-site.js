// content-scripts/test-site.js
//
// Same idea as content-scripts/hollister.js, pointed at the local
// test-site/product.html page instead of a real store. Exists purely so
// you can test the whole flow (click Add To Bag -> track -> Check Now ->
// notification on drop) without waiting for a real sale. See test-site/
// and set_price.py.

const STORE = "test-site";
